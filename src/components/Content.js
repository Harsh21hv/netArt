...
const Content = () => {
  return (
    <div className='ml-72'>
      <div>
        <p className='mr-40 mt-4 text-sm font-semibold font-serif'>
      ...
      <div>
        <img src={IMG} alt='img' className=' w-11/12 h-96  mt-4 relative ' />
      </div>
      <div className='mr-6'>
